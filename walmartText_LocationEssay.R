...
newNames <- c("Zip", "State", "Essay","City", "Abbrev", "latitide", "longitude")
...
wmZip$Essay <- tolower(wmZip$StateComment)
...
walmart <- tm_map(walmart, removeWords, c("wal mart", "walmart",
                                          "sams", "shop", "store", "please"))
...
grx <- glob2rx("*line*|*cashier*|*servic*")
...
hc <- hclust(d)
op = par(bg = "white")
plot(hc, hang = -1, col.main = "blue",col = "blue", lty = 4,col.axis = "orange", axes = FALSE,
     main = "Word Clusters in Essay by State", xlab = "State", col.lab = "Blue")
axis(side = 2, col = "orange", at = seq(0,40,5), labels = FALSE)
mtext(seq(0, 40, 5), side = 2, at = seq(0, 40, 5),
      line = 1, col = "orange", las = 2)
...
op = par(bg = "white")
plot(hc, hang = -1, col.main = "blue",col = "blue", lty = 4,col.axis = "orange", axes = FALSE,
     main = "Clusters in Essay Words Related to Service By State", xlab = "State", col.lab = "Blue")
axis(side = 2, col = "orange", at = seq(0,40,5), labels = FALSE)
mtext(seq(0, 40, 5), side = 2, at = seq(0, 40, 5),
      line = 1, col = "orange", las = 2)
...
op = par(bg = "white")
plot(hc, hang = -1, col.main = "blue",col = "blue", lty = 4,col.axis = "orange", axes = FALSE,
     main = "Clusters in Essay Words Related to Price By State", xlab = "State", col.lab = "Blue")
axis(side = 2, col = "orange", at = seq(0,40,5), labels = FALSE)
mtext(seq(0, 40, 5), side = 2, at = seq(0, 40, 5),
      line = 1, col = "orange", las = 2)
rect.hclust(hc,k = 6, border = "red")
...
op = par(bg = "white")
plot(hc, hang = -1, col.main = "blue",col = "blue", lty = 4,col.axis = "orange", axes = FALSE,
     main = "Clusters in Essay Words Related to Stock By State", xlab = "State", col.lab = "Blue")
axis(side = 2, col = "orange", at = seq(0,40,5), labels = FALSE)
mtext(seq(0, 40, 5), side = 2, at = seq(0, 40, 5),
      line = 1, col = "orange", las = 2)
rect.hclust(hc,k = 6, border = "red")
...
op = par(bg = "white")
plot(hc, hang = -1, col.main = "blue",col = "blue", lty = 4,col.axis = "orange", axes = FALSE,
     main = "Clusters in Essay Words Related to Produce By State", xlab = "State", col.lab = "Blue")
axis(side = 2, col = "orange", at = seq(0,40,5), labels = FALSE)
mtext(seq(0, 40, 5), side = 2, at = seq(0, 40, 5),
      line = 1, col = "orange", las = 2)
rect.hclust(hc,k = 6, border = "red")
