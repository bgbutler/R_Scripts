...
#turn whole dframe into time series
zooTS1 <- merge(Binds,Leads, HC)
zooTS1 <- merge(Binds,Leads)
plot(zooTS1, screens = c(1,2,3), main = "Time Series of Leads and Binds & HC")

#create var model
var1 <- VAR(zooTS1, p = 5, , exog = HC, type ="none",season = 10)
...
var2 <- VAR(zooTSBinds, p = 5, type ="none",season = 10)
