...
url <- '/Users/bryanbutler/Documents/RProjects/PastWork/PolicyListing.csv'
...
# alternate jitter method
zipData$Lat <- jitter(zipData$latitude, amount = .01)
zipData$Lon <- jitter(zipData$longitude, amount = .01)
